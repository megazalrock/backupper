...
2. **Create Specification Document**: Generate a specification document following the standard format and save it to `.mgzl/spec/[spec-file-name]/spec.md`
...
4. Save the document to `.mgzl/spec/[spec-file-name]/spec.md`.
